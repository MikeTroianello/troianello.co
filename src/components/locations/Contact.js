      ...
      <div className='row'>
        <div className='col-5 contact-side-one'>
          ...
          <div className="contact-side-one-box">
            <h3>Phone: 
            <br/><span className='contact-number'>(509)833-8340</span></h3>
            <h3>
            <h3>
              Email:
              <br/>
        ...
        <div className='col-5 contact-side-two'>
          ...
          <form className="contact-message" action="https://formspree.io/mike@troianello.co" method="POST" >
            ...
            <label>
              <textarea rows="7" name='content' className="contact-message-input" placeholder="Message Content"></textarea>
            </label>
